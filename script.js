...
toggleModal("closeApply", "applyModal", "#closeApply", "#cancelApply");
toggleModal("loginRecruiterBtn", "recruiterloginModal", "#closeloginform", "#cancelRJob");
...
toggleModal("closeApply", "applyModal", "#closeApply", "#cancelApply");
toggleModal("loginSeekerBtn", "jobseekerModal", "#closejobseekerform", "#canceljobseekerJob");
